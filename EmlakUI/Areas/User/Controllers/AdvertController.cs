...
namespace EmlakUI.Areas.User.Controllers
{
    ...
    public class AdvertController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var advertsList = await _advertService.BL_ListAsync(new[] { "Type", "Situation", "City", "District" }, x => x.Status == true && x.UserAdminId == id);
        ...
        public async Task<IActionResult> Create()
        {
            ...
            {
                TempData["Usid"] = HttpContext.Session.GetString("Id");
        ...
        public async Task<IActionResult> Create(Advert data)
        {
            ...
            {
                var filePath = Path.Combine("wwwroot/UserPictures/", item.FileName);
        ...
        {
            TempData["Usid"] = _userService.GetUserId();
